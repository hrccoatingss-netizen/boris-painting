        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-8 flex gap-3">
              <a href="https://www.facebook.com/borispainting" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook" className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 transition-all duration-300 hover:bg-accent hover:shadow-lg hover:shadow-accent/20">
